<%@ Page Title="" Language="C#" MasterPageFile="~/Admintemplate.Master" AutoEventWireup="true" CodeBehind="adminprofile.aspx.cs" Inherits="HomePage.adminprofile" %>
...
<hr class="mb-4">
  <asp:Button id="editbtn"  runat="server" type="submit" style=" background-color: #f4b328;border:none" class="btn btn-primary btn-lg btn-block" Text="Edit" OnClick="editbtn_Click1" ></asp:Button><br />
